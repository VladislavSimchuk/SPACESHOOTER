...
def run():
    ...
    boss = Boss(setting_win["WIDTH"] //2 - setting_hero["WIDTH"] // 2,
                - setting_boss["HEIGHT"],
                setting_boss["WIDTH"],
                setting_boss["HEIGHT"],
    ...
    while game:
        ...
        if which_window == 1:
            ...
            if end_time - start_time_boss > 5000:
                boss.LIVE = True
            ...
            if menu == True:
                ...
                window.blit(render_lose, (rect_lose.x + 64, rect_lose.y + 13))
                for event in events:
            ...
            for event in events:
                if event.type == boss_shoot and boss.LIVE:
                    bullet_bot_boss_list.append(Bulled(boss.centerx + 40, boss.bottom, 10, 20, color = (0, 0, 180)))
                    bullet_bot_boss_list.append(Bulled(boss.centerx - 50, boss.bottom, 10, 20, color = (0, 0, 180)))
                if event.type == pygame.KEYDOWN:
                    ...
                    if event.key == pygame.K_SPACE:
                        hero.BULLET_LIST.append(Bulled(hero.centerx - 20, hero.y, 10, 20, color = (255, 20, 20)))
